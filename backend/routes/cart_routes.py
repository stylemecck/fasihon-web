...
# # # Fetch all cart items with total calculation
...
# # # Update cart item quantity (decrease by 1)
...
# #         return jsonify({
# #             "message": f"Cart item quantity {action} successfully",
# #             "updatedItem": cart_item.to_dict() if cart_item.quantity > 0 else None,
# #             "action": action
# #         }), 200
