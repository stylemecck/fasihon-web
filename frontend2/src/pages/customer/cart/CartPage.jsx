    ...
    return (
      <div className="flex items-center justify-center min-h-screen px-4 bg-gray-100">
        <div className="text-center">
          ...
          <h2 className="mb-2 text-2xl font-semibold">Login to view your cart</h2>
          <button
  ...
  if (cartItemsArray.length === 0) {
    return (
      <div className="flex items-center justify-center min-h-screen px-4 bg-gray-100">
        <div className="text-center">
          <ShoppingBag className="mx-auto mb-4" size={36} />
          <h2 className="mb-2 text-2xl font-semibold">Your shopping bag is empty</h2>
          <p className="mb-4 text-gray-500">Start adding products to your cart.</p>
          <button
        ...
        <div className="flex flex-col gap-8 lg:flex-row">
          ...
          <div className="flex-1 bg-white shadow-sm rounded-xl">
            ...
            {cartItemsArray.map((item) => (
              <div key={item.id} className="grid grid-cols-1 gap-4 p-4 border-b md:grid-cols-12 last:border-b-0">
                {/* Product Info */}
          ...
          <div className="space-y-6 lg:w-96">
            <div className="sticky p-6 bg-white shadow-sm rounded-xl top-20">
              ...
              <button
                ...
                className="w-full py-3 mt-6 text-white transition bg-black rounded-lg shadow hover:bg-gray-800"
              >
                Proceed to Checkout
              </button>
